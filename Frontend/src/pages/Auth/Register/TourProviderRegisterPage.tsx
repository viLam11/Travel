// src/pages/Auth/Register/TourProviderRegisterPage.tsx
...
const TourProviderRegisterPage: React.FC = () => {
    ...
    return (
        <AuthLayout
            heroTitle="Travello for Tours"
            heroSubtitle="Chia sẻ những trải nghiệm du lịch tuyệt vời với du khách"
        >
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 w-full max-w-md px-4 sm:px-0">
                ...
                <div className="text-center mt-3">
                    ...
                    <button
                        ...
                        className="text-xs sm:text-sm text-green-600 hover:text-green-700 font-semibold transition-colors underline-offset-2 hover:underline cursor-pointer"
                    >
                        Đăng nhập
                    </button>
                </div>
...
export default TourProviderRegisterPage;
