    ...
    <div className="flex space-x-3">
      {socialButtons.map((button, index) => (
        <motion.button
          ...
          className={`flex-1 flex items-center justify-center py-3 px-6 rounded-lg transition-all duration-200 shadow-sm hover:shadow-md cursor-pointer ${button.bgColor} ${button.textColor}`}
        >
          {button.icon}
