...
public class TravelService implements TravelServiceInterface {
    ...
    public ResponseEntity<Object> searchServices(String keyword, String serviceType, Long minPrice, Long maxPrice, int page, int size, String sortBy, String direction) {
        try {
            ...
            com.travollo.Travel.utils.ServiceType typeEnum = null;
            if (serviceType != null && !serviceType.isEmpty()) {
                try {
                    typeEnum = com.travollo.Travel.utils.ServiceType.valueOf(serviceType.toUpperCase());
                } catch (IllegalArgumentException e) {
                    // Invalid service type, ignore or handle error? For now, ignore filter
                }
            }
